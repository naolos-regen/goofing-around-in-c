...
# main.c:3: 	unsigned short int i = 10;
	movw	$10, -2(%rbp)	#, i
# main.c:5: 	--i;
	subw	$1, -2(%rbp)	#, i	dec 1 beforehand which makes sense for asm
# main.c:8: 	return (0);	        sub <ammount> <what>
				#       or
				#	dec <what> which does sub 1 <what>
	movl	$0, %eax	#, _3
# main.c:9: }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
